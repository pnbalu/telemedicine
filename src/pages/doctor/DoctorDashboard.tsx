...
export default function DoctorDashboard() {
  ...
  const todaysAppointments = [
    { id: 1, patient: 'John Doe', age: 45, gender: 'M', time: '09:00 AM', type: 'Follow-up', status: 'upcoming', avatar: '👨', lastVisit: '2 weeks ago' },
    { id: 2, patient: 'Jane Smith', age: 32, gender: 'F', time: '10:00 AM', type: 'New Consultation', status: 'in-progress', avatar: '👩', lastVisit: 'First visit' },
    { id: 3, patient: 'Mike Johnson', age: 58, gender: 'M', time: '11:30 AM', type: 'Follow-up', status: 'upcoming', avatar: '👨‍💼', lastVisit: '1 month ago' },
    { id: 4, patient: 'Sarah Williams', age: 28, gender: 'F', time: '02:00 PM', type: 'Check-up', status: 'upcoming', avatar: '👩‍💼', lastVisit: '3 months ago' },
    { id: 5, patient: 'David Brown', age: 65, gender: 'M', time: '03:30 PM', type: 'Follow-up', status: 'upcoming', avatar: '👨‍🦳', lastVisit: '1 week ago' },
  ];
                  ...
                  <TableBody>
                    {todaysAppointments.map((appointment) => (
                      <TableRow key={appointment.id} className="hover:bg-gray-50">
                        ...
                        <TableCell>
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-teal-400 to-emerald-400 flex items-center justify-center text-lg">
                              {appointment.avatar}
                            </div>
                            <div>
